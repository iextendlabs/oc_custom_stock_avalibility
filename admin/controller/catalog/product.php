...
class ControllerCatalogProduct extends Controller {
	...
	public function inStockStatus() {
		...
		if(isset($this->request->get['in_stock_status'])){
			$in_stock_status = $this->request->get['in_stock_status'];
		}else{
			$in_stock_status = 0;
		}
		if (isset($this->request->post['selected'])) {
			foreach ($this->request->post['selected'] as $product_id) {
				...
				$this->db->query("UPDATE " . DB_PREFIX . "product SET in_stock_status_id = '" . (int)$in_stock_status . "' WHERE product_id = '" . (int)$product_id . "'");
			}
		}
	...
	protected function getForm() {
				...
				$query = $this->db->query("SHOW COLUMNS FROM " . DB_PREFIX . "product WHERE field = 'in_stock_status_id'");
				...
				$this->db->query("ALTER TABLE " . DB_PREFIX . "product ADD in_stock_status_id int(11) NOT NULL DEFAULT '0' AFTER stock_status_id;");
		...
		$data['stock_statuses'] = $this->model_localisation_stock_status->getStockStatuses();
				...
				if (isset($this->request->post['in_stock_status_id'])) {

		      		$data['in_stock_status_id'] = $this->request->post['in_stock_status_id'];

						} else if (!empty($product_info)) {

							$data['in_stock_status_id'] = $product_info['in_stock_status_id'];

						} else {

							$data['in_stock_status_id'] = 0;
