...
$_['entry_stock_status']     = 'Out Of Stock Status';
				...
				$_['entry_in_stock_status']     = 'In Stock Status:<br/><span class="help">Status shown when a product is in stock. If you won\'t select anything, the default \'In Stock\' status will be displayed.</span>';
